...
import com.ftn.sbnz.service.services.catalog.RecommendationService;
...
public class ServiceOfferingController {
    ...
    public List<ServiceOfferingResponse> recommend(@Valid @RequestBody RecommendationRequest request,
                                                   Authentication authentication) {
        String username = authentication != null ? authentication.getName() : null;
        return recommendationService.recommend(request, username);
    }
